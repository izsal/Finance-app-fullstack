...
import type { Wallet, Category, Budget, Transaction } from './schema'
...
export function exportFinanceToExcel({ user, wallets, categories, budgets, transactions }: ExportData) {
  ...
  const summaryRows = [
    ['LAPORAN KEUANGAN PRIBADI - DOMPETKU'],
